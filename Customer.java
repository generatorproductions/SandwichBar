...
public interface Customer
{
    ...
    String [][] badResponses = {{"...", "Mayonnaise", "Reeee", "[INSERT RESPONSE]", "Eww", "Do better next time kiddo", "Good try", "", "I shouldn't have left my stoop for this", "*Unenthusiastic high-five*"}, 
                                {"[INSERT RESPONSE]", "I don't like sandwiches anyway", "Nah that ain't for me", "That ain't it chief", "Go back to school", "No dawg", "", "Yuck", "You'll get em next time", "Hehe, I don't know (bad)"},
                                {"The person who made this is nucking futs", "[INSERT RESPONSE]", "", "[INSERT RESPONSE]", "You forgot the pickles", "*Walks out the door*", "", "Sweet potato", "", ""}};
