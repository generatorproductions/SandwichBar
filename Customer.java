...
public interface Customer
{
    ...
    String [][] badResponses = {{"...", "Mayonnaise", "Reeee", "[INSERT RESPONSE]", "Eww", "Do better next time kiddo", "Good try", "", "I shouldn't have left my stoop for this", "*Unenthusiastic high-five*"}, 
                                ...
                                {"The person who made this is nucking futs", "[INSERT RESPONSE]", "You failed me... just like my El Gato", "You forgot to carry the Mayonnaise", "You forgot the pickles", "*Walks out the door*", "Was this made by a little elephant?", "Sweet potato", "", ""}};
